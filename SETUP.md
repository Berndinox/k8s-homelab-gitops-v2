...
| VLAN | Subnetz        | Zweck                              | Gateway (VRRP) |
|------|----------------|------------------------------------|----------------|
| 5    | Public (DHCP)  | WAN — direkt L2 am Modem           | —              |
| 10   | 10.0.10.0/24   | DMZ — Cilium LB-Pool (10.0.10.200/28) | 10.0.10.1   |
| 30   | 10.0.30.0/24   | WiFi Guest — isoliert              | 10.0.30.1      |
| 40   | 10.0.40.0/24   | Client                             | 10.0.40.1      |
| 50   | 10.0.50.0/24   | Server — Cilium LB-Pool (10.0.50.200/28), AdGuard Home (.4/.5) | 10.0.50.1 |
| 60   | 10.0.60.0/24   | WiFi Secure (2. SSID, trusted)     | 10.0.60.1      |
| 100  | 10.0.100.0/24  | Kubernetes Cluster, BGP-Peer       | 10.0.100.1     |
| 200  | 10.0.200.0/24  | MGMT (eno1)                        | 10.0.200.1     |
...
- **Cilium BGP**: nur LB-IPs announcen (uRPF: loose)
...
- BGP ASNs: Node-ASN + Router-ASN noch nicht festgelegt
- BGP Peer-IP: Router auf VLAN 100 (vermutlich 10.0.100.1)
